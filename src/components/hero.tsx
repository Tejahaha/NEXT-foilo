...
import { ArrowRight, GithubIcon, Instagram, Linkedin } from "lucide-react"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <h1 className="text-4xl md:text-6xl font-bold mb-4">
              Hi, Im <span className="text-primary">Teja Kanchipamu !</span>
            </h1>
          ...
          {/* Added image in the right column with motion effects */}
          <motion.div 
          ...
          >
            <div className="relative h-[400px] w-full max-w-[500px] rounded-2xl overflow-hidden bg-blue-600/20">
              <Image
